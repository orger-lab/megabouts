...
from megabouts.sparse_coding.sparse_coding import compute_sparse_code
...
@dataclass
class PipelineFullTrackingFast_Result:
...
class PipelineFullTrackingFast():
    ...
    def run(self,tail_angle,x,y,body_angle):
        ...
        # Compute result:
        res = PipelineFullTrackingFast_Result(tracking_data=tracking_data,
